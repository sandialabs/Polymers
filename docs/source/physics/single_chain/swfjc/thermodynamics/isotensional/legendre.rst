SWFJC model thermodynamics (isotensional/legendre)
==================================================

.. autoclass:: polymers.physics.single_chain.swfjc.thermodynamics.isotensional.legendre::SWFJC(number_of_links, link_length, hinge_mass, well_width)
