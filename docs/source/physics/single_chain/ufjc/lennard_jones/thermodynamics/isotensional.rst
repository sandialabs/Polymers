Lennard-Jones-FJC model thermodynamics (isotensional)
=====================================================
...
.. autoclass:: polymers.physics.single_chain.ufjc.lennard_jones.thermodynamics.isotensional::LENNARDJONESFJC(number_of_links, link_length, hinge_mass, link_stiffness)
