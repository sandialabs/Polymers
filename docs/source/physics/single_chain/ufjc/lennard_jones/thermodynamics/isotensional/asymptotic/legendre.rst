Lennard-Jones-FJC model thermodynamics (isotensional/asymptotic/legendre)
=========================================================================

.. autoclass:: polymers.physics.single_chain.ufjc.lennard_jones.thermodynamics.isotensional.asymptotic.legendre::LENNARDJONESFJC(number_of_links, link_length, hinge_mass, link_stiffness)
