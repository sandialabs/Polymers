Log-squared-FJC model thermodynamics (isotensional/asymptotic)
==============================================================
...
.. autoclass:: polymers.physics.single_chain.ufjc.log_squared.thermodynamics.isotensional.asymptotic::LOGSQUAREDFJC(number_of_links, link_length, hinge_mass, link_stiffness)
