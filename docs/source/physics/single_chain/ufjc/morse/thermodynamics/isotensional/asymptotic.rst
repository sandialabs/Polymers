Morse-FJC model thermodynamics (isotensional/asymptotic)
========================================================
...
.. autoclass:: polymers.physics.single_chain.ufjc.morse.thermodynamics.isotensional.asymptotic::MORSEFJC(number_of_links, link_length, hinge_mass, link_stiffness, link_energy)
