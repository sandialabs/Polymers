EFJC model thermodynamics (isotensional/legendre)
=================================================

.. autoclass:: polymers.physics.single_chain.efjc.thermodynamics.isotensional.legendre::EFJC(number_of_links, link_length, hinge_mass, link_stiffness)
