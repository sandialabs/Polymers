EFJC model thermodynamics (isotensional/asymptotic/alternative/legendre)
========================================================================

.. autoclass:: polymers.physics.single_chain.efjc.thermodynamics.isotensional.asymptotic.alternative.legendre::EFJC(number_of_links, link_length, hinge_mass, link_stiffness)
