EFJC model thermodynamics (isotensional/asymptotic/reduced/legendre)
====================================================================

.. autoclass:: polymers.physics.single_chain.efjc.thermodynamics.isotensional.asymptotic.reduced.legendre::EFJC(number_of_links, link_length, hinge_mass, link_stiffness)
