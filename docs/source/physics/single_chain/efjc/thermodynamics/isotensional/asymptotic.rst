EFJC model thermodynamics (isotensional/asymptotic)
===================================================
...
.. autoclass:: polymers.physics.single_chain.efjc.thermodynamics.isotensional.asymptotic::EFJC(number_of_links, link_length, hinge_mass, link_stiffness)
