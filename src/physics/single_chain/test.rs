...
pub struct Parameters
{
    ...
    pub number_of_bonds_minimum: u8,
    pub number_of_bonds_maximum: u8,
    pub bond_stiffness_reference: f64,
    pub bond_stiffness_scale: f64,
    pub bond_energy_reference: f64,
    pub bond_energy_scale: f64,
    pub bond_scission_energy_reference: f64,
    pub bond_scission_energy_scale: f64,
    pub bond_attempt_frequency_reference: f64,
    pub bond_attempt_frequency_scale: f64,
...
impl Default for Parameters
{
    fn default() -> Self
    {
        Self
        {
            ...
            number_of_bonds_minimum: 1,
            number_of_bonds_maximum: 64,
            bond_stiffness_reference: 5e5,
            bond_stiffness_scale: 99e4,
            bond_energy_reference: 1e2,
            bond_energy_scale: 1e1,
            bond_scission_energy_reference: 1e2,
