...
/// The extensible freely-jointed chain (EFJC) model thermodynamics in the isotensional ensemble approximated using an alternative asymptotic approach and a Legendre transformation.
#[pyclass]
#[derive(Copy, Clone)]
pub struct EFJC
{
