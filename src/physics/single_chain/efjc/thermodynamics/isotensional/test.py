...
EFJC = physics.single_chain.efjc.thermodynamics.isotensional.EFJC
            ...
            def residual_rel(nondimensional_link_stiffness):
                ...
                def integrand_numerator(nondimensional_force):
                    ...
                    return (
                        ...
                        model.asymptotic.gibbs_free_energy(
                            force, temperature
                        )
                    )**2
            ...
            def residual_rel(nondimensional_link_stiffness):
                ...
                def integrand_numerator(nondimensional_force):
                    ...
                    return (
                        ...
                        model.asymptotic.gibbs_free_energy_per_link(
                            force, temperature
                        )
                    )**2
            ...
            def residual_rel(nondimensional_link_stiffness):
                ...
                def integrand_numerator(nondimensional_force):
                    ...
                    return (
                        ...
                        model.asymptotic.relative_gibbs_free_energy(
                            force, temperature
                        )
                    )**2
