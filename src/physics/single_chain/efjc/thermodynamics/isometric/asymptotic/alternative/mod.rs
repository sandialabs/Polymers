...
/// The extensible freely-jointed chain (EFJC) model thermodynamics in the isometric ensemble approximated using an alternative alternative asymptotic approach and a Legendre transformation.
pub mod legendre;
