...
impl SWFJC
{
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).end_to_end_length(&force, &temperature))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).end_to_end_length_per_link(&force, &temperature))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).nondimensional_end_to_end_length_per_link(&nondimensional_force))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).gibbs_free_energy(&force, &temperature))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).gibbs_free_energy_per_link(&force, &temperature))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).relative_gibbs_free_energy(&force, &temperature))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).relative_gibbs_free_energy_per_link(&force, &temperature))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).nondimensional_gibbs_free_energy(&nondimensional_force, &temperature))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).nondimensional_gibbs_free_energy_per_link(&nondimensional_force, &temperature))
    }
    ...
    {
        Ok(super::SWFJC::init(self.number_of_links, self.link_length, self.hinge_mass, self.well_width).nondimensional_relative_gibbs_free_energy_per_link(&nondimensional_force))
    }
}
