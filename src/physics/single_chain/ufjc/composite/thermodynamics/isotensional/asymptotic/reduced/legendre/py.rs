...
pub fn register_module(py: Python<'_>, parent_module: &PyModule) -> PyResult<()>
{
    ...
    legendre.add_class::<CUFJC>()?;
    Ok(())
}

/// The composite uFJC (CuFJC) model thermodynamics in the isotensional ensemble using a reduced asymptotic approach and a Legendre transformation.
#[pyclass]
#[derive(Copy, Clone)]
pub struct CUFJC
{
