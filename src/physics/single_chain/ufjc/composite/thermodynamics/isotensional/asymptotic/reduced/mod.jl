"""
The composite uFJC (CuFJC) single-chain model thermodynamics in the isotensional ensemble approximated using a reduced asymptotic approach.
"""
module Reduced
...
"""
The structure of the CuFJC model thermodynamics in the isotensional ensemble approximated using a reduced asymptotic approach.
...
"""
Initializes and returns an instance of the CuFJC model thermodynamics in the isotensional ensemble approximated using a reduced asymptotic approach.
