...
/// The composite uFJC (CuFJC) model thermodynamics in the isometric ensemble approximated using a reduced asymptotic approach and a Legendre transformation.
pub mod legendre;

/// The structure of the thermodynamics of the CuFJC model in the isometric ensemble approximated using a reduced asymptotic approach.
pub struct CUFJC
{
...
/// The implemented functionality of the thermodynamics of the CuFJC model in the isometric ensemble approximated using a reduced asymptotic approach.
impl CUFJC
{
    /// Initializes and returns an instance of the thermodynamics of the CuFJC model in the isometric ensemble approximated using a reduced asymptotic approach.
