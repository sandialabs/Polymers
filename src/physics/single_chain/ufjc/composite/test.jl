...
using Polymers.Physics.SingleChain.Ufjc.Composite: CUFJC

@testset "physics::single_chain::ufjc::composite::test::base::init" begin
    @test isa(
        CUFJC(
...
@testset "physics::single_chain::ufjc::composite::test::base::number_of_links" begin
...
@testset "physics::single_chain::ufjc::composite::test::base::link_length" begin
    for _ = 1:parameters.number_of_loops
        link_length =
...
@testset "physics::single_chain::ufjc::composite::test::base::hinge_mass" begin
    for _ = 1:parameters.number_of_loops
        hinge_mass =
...
@testset "physics::single_chain::ufjc::composite::test::base::number_of_bonds" begin
    for _ = 1:parameters.number_of_loops
        number_of_bonds =
            rand(parameters.number_of_links_minimum:parameters.number_of_links_maximum)
        @test CUFJC(
...
@testset "physics::single_chain::ufjc::composite::test::base::bond_stiffness" begin
    for _ = 1:parameters.number_of_loops
        bond_stiffness =
            parameters.bond_stiffness_reference +
...
@testset "physics::single_chain::ufjc::composite::test::base::bond_energy" begin
    for _ = 1:parameters.number_of_loops
        bond_energy =
...
@testset "physics::single_chain::ufjc::composite::test::base::bond_scission_energy" begin
    for _ = 1:parameters.number_of_loops
...
@testset "physics::single_chain::ufjc::composite::test::base::bond_attempt_frequency" begin
    for _ = 1:parameters.number_of_loops
...
@testset "physics::single_chain::ufjc::composite::test::base::all_parameters" begin
    for _ = 1:parameters.number_of_loops
        number_of_links =
            rand(parameters.number_of_links_minimum:parameters.number_of_links_maximum)
        link_length =
