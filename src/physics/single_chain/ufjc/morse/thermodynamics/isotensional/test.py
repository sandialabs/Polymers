    ...
    def test_end_to_end_length(self):
        ...
        for _ in range(parameters.number_of_loops):
            ...
            def residual_rel(nondimensional_link_stiffness):
                ...
                link_energy = link_stiffness/2*link_length**2
                model = MORSEFJC(
                    number_of_links,
                    link_length,
                    hinge_mass,
                ...
                nondimensional_morse_parameter = np.sqrt(
                    link_stiffness*link_length**2/link_energy/2
                )
                nondimensional_link_stretch_max = 1 + \
                    np.log(2)/nondimensional_morse_parameter
