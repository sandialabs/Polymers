...
pub fn register_module(py: Python<'_>, parent_module: &PyModule) -> PyResult<()>
{
    ...
    asymptotic.add_class::<LOGSQUAREDFJC>()?;
    Ok(())
}
...
pub struct LOGSQUAREDFJC
{
    ...
    #[pyo3(get)]
    pub reduced: super::reduced::py::LOGSQUAREDFJC,
...
impl LOGSQUAREDFJC
{
    ...
    pub fn init(number_of_links: u8, link_length: f64, hinge_mass: f64, link_stiffness: f64) -> Self
    {
        LOGSQUAREDFJC
        {
            ...
            number_of_links,
            link_stiffness,
            reduced: super::reduced::py::LOGSQUAREDFJC::init(number_of_links, link_length, hinge_mass, link_stiffness),
    ...
    ///
    /// where the nondimensional link potential :math:`\beta u` is given by
    ///
    /// .. math::
    ///     \beta u(\lambda) = \frac{\varepsilon}{2}\left[\ln(\lambda)\right]^2,
    ///
    /// where :math:`\varepsilon\equiv\beta u_b=\kappa` is the nondimensional potential energy scale,
    /// :math:`1/c\equiv 1-u'''(1)/2u''(1)=5/2` is related to anharmonicity,
