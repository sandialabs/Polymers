...
use crate::physics::single_chain::ufjc::log_squared::thermodynamics::isotensional::asymptotic::nondimensional_end_to_end_length_per_link as isotensional_nondimensional_end_to_end_length_per_link;
mod base
{
    use super::*;
    use rand::Rng;
