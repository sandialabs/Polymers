...
LOGSQUAREDFJC = physics.single_chain.ufjc.log_squared.thermodynamics. \
    isometric.asymptotic.legendre.LOGSQUAREDFJC
...
def isotensional_nondimensional_end_to_end_length_per_link(
    ...
    """
    return physics.single_chain.ufjc.log_squared.thermodynamics. \
        isotensional.asymptotic. \
        LOGSQUAREDFJC(8, link_length, 1.0, link_stiffness). \
