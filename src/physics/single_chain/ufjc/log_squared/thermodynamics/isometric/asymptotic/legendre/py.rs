...
pub fn register_module(py: Python<'_>, parent_module: &PyModule) -> PyResult<()>
{
    ...
    legendre.add_class::<LOGSQUAREDFJC>()?;
    Ok(())
}

/// The log-squared link potential freely-jointed chain (log-squared-FJC) model thermodynamics in the isometric ensemble approximated using an asymptotic approach and a Legendre transformation.
#[pyclass]
#[derive(Copy, Clone)]
