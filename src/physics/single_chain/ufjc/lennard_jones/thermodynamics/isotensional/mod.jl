...
function LENNARDJONES(
    ...
    return LENNARDJONES(
        ...
        hinge_mass,
        link_stiffness,
        Asymptotic.LENNARDJONES(number_of_links, link_length, hinge_mass, link_stiffness),
        Legendre.LENNARDJONES(number_of_links, link_length, hinge_mass, link_stiffness),
