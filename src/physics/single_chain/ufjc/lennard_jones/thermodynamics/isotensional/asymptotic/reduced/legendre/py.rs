...
pub fn register_module(py: Python<'_>, parent_module: &PyModule) -> PyResult<()>
{
    ...
    legendre.add_class::<LENNARDJONESFJC>()?;
    Ok(())
}

/// The Lennard-Jones link potential freely-jointed chain (log-squared-FJC) model thermodynamics in the isotensional ensemble approximated using a reduced asymptotic approach and a Legendre transformation.
#[pyclass]
#[derive(Copy, Clone)]
