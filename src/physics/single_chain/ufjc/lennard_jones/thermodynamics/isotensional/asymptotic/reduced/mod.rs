...
{
    1.0/nondimensional_force.tanh() - 1.0/nondimensional_force + nondimensional_link_stretch(nondimensional_link_stiffness, nondimensional_force) - 1.0
}
