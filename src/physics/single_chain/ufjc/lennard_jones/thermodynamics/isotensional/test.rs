    ...
    fn end_to_end_length()
    {
        ...
        for _ in 0..parameters.number_of_loops
        {
            ...
            let residual_rel = |nondimensional_link_stiffness|
            {
                ...
                let nondimensional_force_max = nondimensional_link_stretch_max;
            ...
            let residual_rel_1 = residual_rel(5.0*parameters.nondimensional_link_stiffness_big);
            let residual_rel_2 = residual_rel(5.0*parameters.nondimensional_link_stiffness_big*parameters.log_log_scale);
