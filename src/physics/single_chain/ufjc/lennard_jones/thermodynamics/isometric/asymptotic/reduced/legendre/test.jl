...
using Polymers.Physics.SingleChain.Ufjc.LennardJones.Thermodynamics.Isometric.Asymptotic.Reduced.Legendre: LENNARDJONESFJC
using Polymers.Physics.SingleChain.Ufjc.LennardJones.Thermodynamics.Isotensional.Asymptotic.Reduced: nondimensional_end_to_end_length_per_link as isotensional_nondimensional_end_to_end_length_per_link
...
@testset "physics::single_chain::ufjc::lennard_jones::thermodynamics::isometric::asymptotic::reduced::legendre::test::nondimensional::force" begin
    for _ = 1:parameters.number_of_loops
        ...
        lambda_max = (13/7)^(1/6)
        nondimensional_force_max = link_stiffness/BOLTZMANN_CONSTANT/temperature*link_length^2/6*(lambda_max^(-7) - lambda_max^(-13))
