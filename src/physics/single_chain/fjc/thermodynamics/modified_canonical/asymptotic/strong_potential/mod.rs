...
pub fn nondimensional_force(number_of_links: &u8, nondimensional_potential_distance: &f64, nondimensional_potential_stiffness: &f64) -> f64
{
    ...
    (1.0/nondimensional_potential_distance + (0.5*number_of_links_f64 - 1.0)*sum_1/sum_0)/number_of_links_f64
    
    + 0.5/nondimensional_potential_stiffness/number_of_links_f64*
    (

        (0.5*number_of_links_f64 - 1.0)*
        (
            
            (0.5*number_of_links_f64 - 1.0)*sum_1/sum_0*
            (
                
                (number_of_links_f64 - 2.0)*(sum_1/sum_0).powi(2) - (number_of_links_f64 - 3.0)*sum_2/sum_0
            
            ) - (0.5*number_of_links_f64 - 1.5)*
            (
                
                (0.5*number_of_links_f64 - 1.0)*sum_1*sum_2/sum_0.powi(2) - (0.5*number_of_links_f64 - 2.0)*sum_3/sum_0
            
            )
        
        )
        
        + 2.0*nondimensional_potential_distance.powi(-3)
        
        - 2.0*
        (
            
            (0.5*number_of_links_f64 - 1.0)*sum_1/sum_0 + nondimensional_potential_distance.powi(-1)
        
        )*(
            
            (0.5*number_of_links_f64 - 1.0)*((0.5*number_of_links_f64 - 1.0)*(sum_1/sum_0).powi(2) - (0.5*number_of_links_f64 - 1.5)*sum_2/sum_0) - nondimensional_potential_distance.powi(-2)
